...
import 'package:Xception/core/model/customer/job/new_job_request.dart';
...
class NewJobNotifier extends BaseChangeNotifier {
  ...
  NewJobNotifier(this.vendorId, this.vendorName, this.serviceName) {
    initApi();
  }

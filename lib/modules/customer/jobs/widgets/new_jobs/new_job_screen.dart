import 'package:Xception/core/model/common/dropdown/priority_dropdown_response.dart';
import 'package:Xception/core/model/common/dropdown/service_dropdown_response.dart';
import 'package:Xception/modules/customer/jobs/widgets/new_jobs/new_job_notifier.dart';
...
class NewJobScreen extends StatelessWidget {
  ...
  const NewJobScreen({super.key, this.vendorId, this.vendorName, this.serviceName});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => NewJobNotifier(vendorId, vendorName, serviceName),
      child: Consumer<NewJobNotifier>(
  ...
  Widget buildBody(BuildContext context, NewJobNotifier newServicesNotifier) {
    print("serviceName");
    print(serviceName);
    return SafeArea(
      child: Scaffold(

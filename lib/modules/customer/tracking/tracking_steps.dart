...
class TrackingStepsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<TrackingStep> steps = [
      ...
      TrackingStep(title: 'Assigned to Employee', time: '08:10 AM'),
      TrackingStep(title: 'Employee on the Way', time: '08:30 AM'),
      TrackingStep(title: 'Job Started', time: '09:00 AM'),     // not yet
    ];

...
import 'package:Xception/modules/common/settings/settings_notifier.dart';
                ...
                children: [
                  ...
                  _buildSettingsGroup(
                    [
                      ...
                      if(settingsNotifier.userData?.customerType == "V") _tileData(LucideIcons.cog, "Edit Services", 'edit-jobs'),
